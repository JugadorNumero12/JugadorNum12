...
<?php foreach ( $emails as $i=>$email ){ ?>
	...
	<tr> 
		...
		<td> <?php echo CHtml::button('Borrar', array('submit' => array('emails/eliminarEmails', 'id'=>$email['id_email'],'borrado'=>'borrado_to'),'class'=>"button small black")); ?> </td>
	</tr>
...
<tr> 
	...
	<td> &nbsp; &nbsp; &nbsp; </td>
	<td><?php echo CHtml::button('Borrar mensajes ', array('submit' => array('emails/eliminarEmails', 'id'=>0, 'borrado'=>"borrado_to"),'class'=>"button small black")); ?> </td>
</tr>
</table>
