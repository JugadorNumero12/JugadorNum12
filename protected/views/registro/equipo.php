	...
	<div class="elegir-equipo">
		<table>
			<tr>
				...
				<td><input type="image" value="1" onclick="$(this).setIdEquipo(this.value);" title="¡Vuela alto! ¡Vuela rápido! ¡Vuela como un &Aacute;guila roja!" src="<?php echo Yii::app()->BaseUrl.'/images/escudos/rojos.png'; ?>" class="escudos" alt="Rojos"/></td>
				...
				<td><input type="image" value="3" onclick="$(this).setIdEquipo(this.value)" title="Se acerca tu derrota. Somos los Black Starks." src="<?php echo Yii::app()->BaseUrl.'/images/escudos/negros.png'; ?>" class="escudos" alt="Negros"></td>
				<td><input type="image" value="4" onclick="$(this).setIdEquipo(this.value)" title="Tiembla antes los furiosos Osos Blancos" src="<?php echo Yii::app()->BaseUrl.'/images/escudos/blancos.png'; ?>" class="escudos" alt="Blancos"></td>
			</tr>
			<tr>
