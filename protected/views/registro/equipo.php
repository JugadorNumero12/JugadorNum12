	...
	<div class="elegir-equipo">
		<table>
			...
			<tr>
				...
				<td><input type="image" value="8" onclick="$(this).setIdEquipo(this.value)" title="Se acerca tu derrota. Somos los Black Starks." src="<?php echo Yii::app()->BaseUrl.'/images/escudos/negros.png'; ?>" class="escudos" alt="Negros"></td>
			</tr>
			<tr>
