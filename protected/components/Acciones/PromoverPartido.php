...
class PromoverPartido extends AccionGrupSingleton
{
   ...
   public static function getInstance()
   {
	...
	public function ejecutar($id_accion)
	{
	    ...
	    $ret = min($ret,Partidos::aumentar_factores($sigPartido->id_partido,$equipo->id_equipo,"ambiente",Efectos::$datos_acciones['PromoverPartido']['ambiente']));
	    $ret = min($ret,Partidos::aumentar_factores_prop($sigPartido->id_partido,$equipo->id_equipo,"aforo",Efectos::$datos_acciones['PromoverPartido']['aforo']));
	    $ret = min($ret,Partidos::aumentar_factores($sigPartido->id_partido,$equipo->id_equipo,"moral",Efectos::$datos_acciones['PromoverPartido']['moral']));
