...
INSERT INTO `habilidades` (`codigo`, `tipo`, `nombre`, `descripcion`, `dinero`, `animo`, `influencias`, `dinero_max`, `animo_max`, `influencias_max`, `participantes_max`, `cooldown_fin`, `token`) VALUES
 ...
 ('ContactarYakuza', 1, 'Contactar con la Yakuza japonesa', '"¿Te creías importante? No existe ningún tiburón de los negocios fuera de su alcance."',                                                                                                                                           3000, 20, 8, NULL, NULL, NULL, 1, 200, 'contactos_yakuza'),                     
