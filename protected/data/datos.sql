...
INSERT INTO `habilidades` (`codigo`, `tipo`, `nombre`, `descripcion`, `dinero`, `animo`, `influencias`, `dinero_max`, `animo_max`, `influencias_max`, `participantes_max`, `cooldown_fin`, `token`) VALUES
 ...
 ('Pintarse', 0, 'Pintarse con los colores del equipo', '"Demuestra tu pasión por los colores de tu equipo. Sube el ambiente para el próximo partido"',                                                                                                                                         1000, 80,  16,  10000, 2000, 40,             6, 600, 'pintarse_colores_equipo'),                     
 ...
 ('AlquilarBus', 0, 'Alquilar bus de hinchas para ir a animar el partido', '"Mueve a toda la peña para ir al próximo partido del equipo y llenar el estadio"',                                                                                                                                  2000, 75, 2, 20000, 1800, 11,               9, 600, 'alquilar_bus'),
 ...
 ('RetransmitirRRSS', 2, 'Retransmitir el partido por las redes sociales', '"Ocúpate de que el partido tenga repercusión."',                                                                                                                                                                    0,    40,   1,     NULL, NULL, NULL,           1, 10, 'retransmitir_redes_sociales'),
 ('DoblarApuesta', 2, 'Doblar la apuesta durante el partido', '"Seguramente hoy sea tu día de suerte"',                                                                                                                                                                                         750,  0,    0,     NULL, NULL, NULL,           1, 10, 'doblar_apuesta'), 
