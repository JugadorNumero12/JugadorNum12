...
INSERT INTO `habilidades` (`codigo`, `tipo`, `nombre`, `descripcion`, `dinero`, `animo`, `influencias`, `dinero_max`, `animo_max`, `influencias_max`, `participantes_max`, `cooldown_fin`, `token`) VALUES
 ...
 ('EscribirBlog', 3, 'Escribir blog de opinión', '"Al principio tendrás 2 visitas, la tuya y la de tu madre... pero si trabajas en él a diário con paciencia podrías convertir tu voz en un referente"',                                                                                        20, 25, 1,            NULL, NULL, NULL,  1, NULL, 'escribir_blog'),
