...
Nota
    Función sin revisar por no disponer del código actualizado.
...
Modelo
    Comprobar que se pide mostrar una habilidad existente.
...
####Partidos.asistir
Notas
    Solo mostrar una pantalla con el texto "has asistido al partido p del equipo e"
